...
Apple Podcasts desktop app for Windows. Loads [podcasts.apple.com](https://podcasts.apple.com) in a native **Tauri / WebView2** shell.
...
- **Deep link** — `apple-podcasts://` protocol handler

## Installation

1. Download the latest installer from [Releases](https://github.com/taylorivanoff/apple-podcasts-windows/releases)
